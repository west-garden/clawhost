...
var builtinProviders = map[string]ProviderMeta{
	...
	"qwen-coding": {
		...
		Models: []ModelInfo{
			...
			{ID: "qwen3-coder-next", Name: "Qwen3 Coder Next", ContextWindow: 131072, MaxTokens: 8192, Input: []string{"text"}},
			{ID: "qwen3-coder-plus", Name: "Qwen3 Coder Plus", ContextWindow: 131072, MaxTokens: 8192, Input: []string{"text"}},
			{ID: "MiniMax-M2.5", Name: "MiniMax M2.5", ContextWindow: 192000, MaxTokens: 8192, Input: []string{"text"}},
